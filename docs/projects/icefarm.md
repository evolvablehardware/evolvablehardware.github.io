...
[:octicons-mark-github-16: evolvablehardware/iCEFARM]({{config.extra.link.project.iCEFARM.repo}}){ .md-button } 
[iCEFARM Docs]({{config.extra.link.project.iCEFARM.docs}}){ .md-button }

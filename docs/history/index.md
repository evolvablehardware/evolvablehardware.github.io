---
title: About EHW
description: The History and Current Reality of Evolvable Hardware.
hide:
    #- toc
    - navigation
    - path
...
To get a high-level overview of the history of the field we have a brief timeline to place significant events through the years.

[See the Timeline](timeline.md){ .md-button .md-button--primary } 

...
-   :material-select-inverse:{ .lg .middle } __Variance Maximization__

    ---

    Evolve a physical circuit on an FPGA to maximize the circuit's output variance (i.e., maximize noise).

    [:octicons-arrow-right-24: Learn More](./variance_maximization.md)

-   :material-select-inverse:{ .lg .middle } __Pulse Oscillation__
...
- :material-select-inverse:{ .lg .middle } __Tone Discrimination__

    ---

    Evolve circuits to discriminate between different input frequencies.

    [:octicons-arrow-right-24: Learn More](./tone_discriminator.md)


-  :material-select-inverse:{ .lg .middle } __Target Frequency Sweep (2025)__
...
-  :material-select-inverse:{ .lg .middle } __Fitness Sensitivity (2025)__
...
-  :material-select-inverse:{ .lg .middle } __Transferability (2025)__
    ---

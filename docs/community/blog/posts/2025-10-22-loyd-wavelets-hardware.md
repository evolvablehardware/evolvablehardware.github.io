...
1. A two-stage algorithm that evolves wavelets and hardware separately
2. A paired algorithm that evolves them together
3. A cooperative coevolutionary algorithm that maintains two separate populations of wavelets and hardware

...
See existing experiments in [Research > Experiments](../research/experiments/index.md) for the expected format and level of documentation.

## Contributing to the Website

This documentation site is open source. To add or improve content:

1. Fork the [website repository](https://github.com/evolvablehardware/evolvablehardware.github.io)
2. The site is built with [MkDocs Material](https://squidfunk.github.io/mkdocs-material/) — all content is Markdown
